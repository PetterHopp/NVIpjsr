...
test_that("build_sql_select_code", {
  ...
  expect_equal(query, "", ignore_attr = TRUE)

  query <- build_sql_select_code(values = "0100101", varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode = '0100101'", ignore_attr = TRUE)

  query <- build_sql_select_code(values = "0100101%", varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode LIKE '0100101%'", ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101", "0100102"), varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode IN ('0100101', '0100102')", ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101%", "0100102%"), varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode LIKE '0100101%' OR hensiktkode LIKE '0100102%'", ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101", "0100102%"), varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode = '0100101' OR hensiktkode LIKE '0100102%'", ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101", "0100101007", "0100102%", "0100202%"),
                                 varname = "hensiktkode",
                                 db = "PJS")
  expect_equal(query,
               "hensiktkode IN ('0100101', '0100101007') OR hensiktkode LIKE '0100102%' OR hensiktkode LIKE '0100202%'",
               ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101", "0100102", NA), varname = "hensiktkode", db = "PJS")
  expect_equal(query, "hensiktkode IS NULL OR hensiktkode IN ('0100101', '0100102')", ignore_attr = TRUE)

  query <- build_sql_select_code(values = c("0100101%", "0100102%", NA), varname = "hensiktkode", db = "PJS")
  expect_equal(query,
               "hensiktkode IS NULL OR  hensiktkode LIKE '0100101%' OR hensiktkode LIKE '0100102%'",
               ignore_attr = TRUE)

  query <- build_sql_select_code(values = c(NA, "0100101", "0100102%", NA), varname = "hensiktkode", db = "PJS")
  expect_equal(query,
               "hensiktkode IS NULL OR hensiktkode = '0100101' OR hensiktkode LIKE '0100102%'",
               ignore_attr = TRUE)
